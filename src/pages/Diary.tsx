...
export function Diary() {
  ...
  const invalidUnit = (unit === 'unidade' && !(Number(selectedFood?.unitWeightG) > 0)) || (unit === 'porção' && !(Number(selectedFood?.portionWeightG) > 0))
